...
- Use Star Wars API to search for characters based on an input's value 
...
- Define an abort controller to abort any ongoing effect when a new effect is fired
...
DOCS:
- [Star Wars API](https://swapi.dev/documentation#search)
